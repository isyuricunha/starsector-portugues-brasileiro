...
public class Samarra {
	...
	// Tigra Ring
		system.addAsteroidBelt(samarra_star, 100, 3000, 500, 100, 190, Terrain.ASTEROID_BELT, "Anel de Tigra");
		...
		SectorEntityToken tigra_city = system.addCustomEntity("tigra_city", "Cidade de Tigra", "station_side00", "hegemony");
	...
	// Eventide
		...
		samarra1.setInteractionImage("illustrations", "eventide");
			...
			SectorEntityToken eventide_mirror1 = system.addCustomEntity("eventide_mirror1", "Espelho Estelar Eventide Alfa", "stellar_mirror", "hegemony");
			SectorEntityToken eventide_mirror2 = system.addCustomEntity("eventide_mirror2", "Espelho Estelar Eventide Beta", "stellar_mirror", "hegemony");	
			SectorEntityToken eventide_mirror3 = system.addCustomEntity("eventide_mirror3", "Espelho Estelar Eventide Gama", "stellar_mirror", "hegemony");
			SectorEntityToken eventide_mirror4 = system.addCustomEntity("eventide_mirror4", "Espelho Estelar Eventide Delta", "stellar_mirror", "hegemony");
			SectorEntityToken eventide_mirror5 = system.addCustomEntity("eventide_mirror5", "Espelho Estelar Eventide Épsilon", "stellar_mirror", "hegemony");
			...
			SectorEntityToken eventide_shade1 = system.addCustomEntity("eventide_mirror1", "Sombra Estelar Eventide Ômega", "stellar_shade", "hegemony");
			SectorEntityToken eventide_shade2 = system.addCustomEntity("eventide_mirror3", "Sombra Estelar Eventide Psi", "stellar_shade", "hegemony");
			SectorEntityToken eventide_shade3 = system.addCustomEntity("eventide_mirror5", "Sombra Estelar Eventide Qui", "stellar_shade", "hegemony");
			...
			SectorEntityToken samarra_relay = system.addCustomEntity("samarra_relay", // unique id
					 "Rede de Comunicações de Samarra", // name - if null, defaultName from custom_entities.json will be used
					 "comm_relay", // type of object, defined in custom_entities.json
					 "hegemony"); // faction
			samarra_relay.setCircularOrbitPointingDown( system.getEntityById("samarra"), 30 - 60, 4000, 200);
	
			// Samarra Jump - L4 (ahead)
			JumpPointAPI jumpPoint = Global.getFactory().createJumpPoint("samarra_jump_point_alpha", "Ponto de Salto de Samarra");
		...
		SectorEntityToken samarra_gate = system.addCustomEntity("samarra_gate", // unique id
				 "Portal de Samarra", // name - if null, defaultName from custom_entities.json will be used
	...
	// Typhon System
		...
		samarra2.setCustomDescriptionId("planet_typhon");
			...
			SectorEntityToken orthrus_relay = system.addCustomEntity("orthrus_relay", // unique id
					 "Rede de Comunicações de Ortro", // name - if null, defaultName from custom_entities.json will be used
					 "comm_relay", // type of object, defined in custom_entities.json
					 "independent"); // faction
			...
			SectorEntityToken typhonL4 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						"Asteroides de Tífon L4")); // null for default name
			...
			SectorEntityToken typhonL5 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						4f, // min asteroid radius 
						16f, // max asteroid radius
						"Asteroides de Tífon L5")); // null for default name
