...
public class Yma {
	...
	public void generate(SectorAPI sector) {
		...
		yma3.applySpecChanges();
			...
			SectorEntityToken neutralStation = system.addCustomEntity("yma_abandoned_station", "Estação de Sifão Abandonada", "station_side05", "neutral");
			...
			SectorEntityToken chupi_orcoL4 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						"Asteroides L4 de Chupi Orco")); // null for default name
			...
			SectorEntityToken chupi_orcoL5 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						4f, // min asteroid radius 
						16f, // max asteroid radius
						"Asteroides L5 de Chupi Orco")); // null for default name
			
			chupi_orcoL4.setCircularOrbit(yma_star, 45 + 60, 7300, 450);
			chupi_orcoL5.setCircularOrbit(yma_star, 45 - 60, 7300, 450);
			
			// Viscacha Jumppoint
			JumpPointAPI jumpPoint = Global.getFactory().createJumpPoint("viscacha_jump", "Ponto de Salto Viscacha");
			...
			SectorEntityToken gate = system.addCustomEntity("yma_gate", // unique id
					 "Portal Yma", // name - if null, defaultName from custom_entities.json will be used
	...
	// YMA B
		...
		yma_b1.setCustomDescriptionId("planet_qaras");
			...
			// Qaras mirror system 
			SectorEntityToken qaras_mirror1 = system.addCustomEntity("qaras_mirror1", "Espelho Estelar Qaras", "stellar_mirror", "pirates");
		...
		SectorEntityToken qaras_relay = system.addCustomEntity("qaras_relay", // unique id
				 "Rele Qaras", // name - if null, defaultName from custom_entities.json will be used
				 "comm_relay", // type of object, defined in custom_entities.json
				 "pirates"); // faction
		qaras_relay.setCircularOrbitPointingDown( yma_star_b, 0 - 60, 2000, 100);
		
		// Yma B Jumppoint
		JumpPointAPI jumpPoint2 = Global.getFactory().createJumpPoint("viscacha_jump", "Ponto de Salto Yma B");
