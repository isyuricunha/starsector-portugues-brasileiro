...
public class Hybrasil {
	...
	public void generate(SectorAPI sector) {
		...
		SectorEntityToken culannStation = system.addCustomEntity("culann_starforge", "Forja Estelar de Culann", "station_side07", "tritachyon");
	...
	// Elada System 
		...
		// & the moons of Elada
			...
			hybrasil2a.setInteractionImage("illustrations", "eochu_bres");
				...
				SectorEntityToken eochu_bres_mirror1 = system.addCustomEntity("eochu_bres_mirror1", "Espelho Estelar de Eochu Bres", "stellar_mirror", "tritachyon");
				...
				SectorEntityToken eochu_bres_mirror2 = system.addCustomEntity("eochu_bres_mirror2", "Espelho Estelar de Eochu Bres", "stellar_mirror", "tritachyon");
				...
				SectorEntityToken eochu_bres_mirror3 = system.addCustomEntity("eochu_bres_mirror3", "Espelho Estelar de Eochu Bres", "stellar_mirror", "tritachyon");
			...
			SectorEntityToken relay = system.addCustomEntity("elada_relay", // unique id
					 "Rede de Relés de Elada", // name - if null, defaultName from custom_entities.json will be used
...
//		hybrasil3.setInteractionImage("illustrations", "mine");
		...
		JumpPointAPI jumpPoint = Global.getFactory().createJumpPoint("hybrasil_inner_jump", "Ponto de Salto do Sistema Interno de Hybrasil");
