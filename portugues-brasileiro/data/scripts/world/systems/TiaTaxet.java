...
public class TiaTaxet {
	...
	public void generate(SectorAPI sector) {
		...
		*/
		...
		system.addAsteroidBelt(tia_star, 150, 3600, 170, 200, 250, Terrain.ASTEROID_BELT, "Toro de Lagua");
		...
		SectorEntityToken tia_field1 = system.addTerrain(Terrain.ASTEROID_FIELD,
				new AsteroidFieldParams(
					...
					"Aglomerado de Asteroides Tia-Ta'xet")); // null for default name
		
		tia_field1.setCircularOrbit(tia_star, 180, 4500, 250);
		
		
		// Abandoned shipyard /research station
			SectorEntityToken abandoned_station1 = system.addCustomEntity("abandoned_spacedock", "Estação de Pesquisa Abandonada", "station_side00", "neutral");
		...
		SectorEntityToken tia_field4 = system.addTerrain(Terrain.ASTEROID_FIELD,
				new AsteroidFieldParams(
					...
					4f, // min asteroid radius 
					16f, // max asteroid radius
					"Os Mosquitos")); // null for default name
		
		tia_field4.setCircularOrbit(tia_star, 180, 5700, 400);
		
		
		// Tia-Ta'xet Jumppoint
		JumpPointAPI jumpPoint2 = Global.getFactory().createJumpPoint("tia-taxet_jump", "Ponto de Salto Tia-Ta'xet");
