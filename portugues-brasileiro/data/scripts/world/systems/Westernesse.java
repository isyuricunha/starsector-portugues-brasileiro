...
public class Westernesse {
	...
	public void generate(SectorAPI sector) {
		...
		JumpPointAPI jumpPoint1 = Global.getFactory().createJumpPoint("westernesse_jump", "Ponto de salto de Westernesse");
		...
		SectorEntityToken westernesse_relay = system.addCustomEntity("westernesse_relay", "Relé de Westernesse", "comm_relay", "persean");
