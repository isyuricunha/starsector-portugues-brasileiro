...
public class Mayasura {
	...
	public void generate(SectorAPI sector) {
		...
		mayasura_c.applySpecChanges();
			...
			system.addRingBand(mayasura_c, "misc", "rings_special0", 256f, 0, new Color(255,230,100,255), 256f, 420, 60f, Terrain.RING, "Grilhões de Gelan");
		
		// Mayasura Jumppoint in the L-something of Gelan
		JumpPointAPI jumpPoint = Global.getFactory().createJumpPoint("mayasura_jump", "Ponto de Salto de Mayasura");
		...
		mayasura_d.setInteractionImage("illustrations", "mairaath");
			...
			SectorEntityToken mairaathStation1 = system.addCustomEntity("mairaath_abandoned_station1",
				"Astrópole Abandonada", "station_side06", "neutral");
		...
		system.addAsteroidBelt(mayasura_star, 90, 4300, 200, 140, 180, Terrain.ASTEROID_BELT, "Os Danavas");
		system.addRingBand(mayasura_star, "misc", "rings_dust0", 256f, 0, Color.white, 256f, 4360, 160f);
			...
			SectorEntityToken pirateStation = system.addCustomEntity("mairaath_abandoned_station2",
					"Astrópole Perdida", "station_side06", "pirates");
		...
		system.addAsteroidBelt(mayasura_star, 120, 5130, 300, 200, 300, Terrain.ASTEROID_BELT, "Os Daitya");
		...
		mayasura_e.applySpecChanges();
			...
			SectorEntityToken tritachStation = system.addCustomEntity("port_tse", "Estação Franquia Porto Tse", "station_side00", "tritachyon");
			...
			PlanetAPI mayasura_e1 = system.addPlanet("arjun", mayasura_e, "Mundo de Arjun", "rocky_unstable", 0, 60, 510, 30);
		...
		// Mayasura Relay
		SectorEntityToken mayasura_relay = system.addCustomEntity("mayasura_relay", "Relé de Mayasura", "comm_relay", "tritachyon");
		...
		system.addAsteroidBelt(mayasura_star, 150, 7500, 400, 370, 430, Terrain.ASTEROID_BELT, "O Takshaka");
