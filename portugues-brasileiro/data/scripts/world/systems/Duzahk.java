...
public class Duzahk {
	...
	public void addHyperspaceStation(final SectorAPI sector) {
		...
		final SectorEntityToken hyperstation = hyper.addCustomEntity("hyperstation_test", "Estação Hiper", "station_mining00", Factions.INDEPENDENT);
...
//		});
	...
	public void generate(SectorAPI sector) {
		...
		system.addAsteroidBelt(duzahk_star, 50, 2400, 100, 30, 40, Terrain.ASTEROID_BELT, "Os Daevas");
