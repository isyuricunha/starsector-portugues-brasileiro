...
public class Galatia {
	...
	public void generate(SectorAPI sector) {
		...
		SectorEntityToken ancyraStation = system.addCustomEntity("ancyra_station", "Instalação Orbital de Ancara", "station_side00", Factions.HEGEMONY);
		...
		SectorEntityToken relay = system.addCustomEntity("ancyra_relay", // unique id
				 "Rele de Ancara", // name - if null, defaultName from custom_entities.json will be used
		...
		SectorEntityToken pontus = system.addPlanet("pontus", star, "Pontus", "gas_giant", 200, 300, 6200, 400);
			...
			SectorEntityToken galatiaAcademy = system.addCustomEntity("station_galatia_academy", "Estação da Academia de Galatia", "station_galatia", Factions.INDEPENDENT);
		...
		SectorEntityToken derinkuyuStation = system.addCustomEntity("derinkuyu_station", "Estação de Mineração Derinkuyu", "station_mining00", Factions.PIRATES);
		...
		SectorEntityToken gate = system.addCustomEntity("galatia_gate", // unique id
				 "Portal de Galatia", // name - if null, defaultName from custom_entities.json will be used
		...
		JumpPointAPI inner = Global.getFactory().createJumpPoint("galatia_jump_point_alpha", "Ponto de salto do Sistema Interno");
		...
		JumpPointAPI fringe = Global.getFactory().createJumpPoint("galatia_jump_point_fringe", "Ponto de salto da Periferia");
