...
public class KumariKandam {
	...
	public void generate(SectorAPI sector) {
		...
		kumarikandam_b.setCustomDescriptionId("planet_kumari_aru");
			...
			// Beholder Station
			SectorEntityToken beholder_station = system.addCustomEntity("beholder_station", "Estação Beholder", "station_side05", "luddic_church");
			...
			SectorEntityToken kumari_aruL4 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						"Asteroides L4 de Kumari Aru")); // null for default name
			...
			SectorEntityToken kumari_aruL5 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						4f, // min asteroid radius 
						16f, // max asteroid radius
						"Asteroides L5 de Kumari Aru")); // null for default name
		...
		chalcedon_loc.setCircularOrbitPointingDown(kumarikandam_star, 220-180, 4300, 180);
			...
			// Destroyed station
			SectorEntityToken abandoned_station1 = system.addCustomEntity("abandoned_spacedock", "Estaleiro Abandonado", "station_side00", "neutral");
			...
			SectorEntityToken gate = system.addCustomEntity("kumari_gate", // unique id
					 "Portal Kumariano", // name - if null, defaultName from custom_entities.json will be used
					 "inactive_gate", // type of object, defined in custom_entities.json
					 null); // faction
			gate.setCircularOrbit(kumarikandam_star, 220-60, 4300, 180);
			
			// a jump in the other one: Rama's Bridge :  Jump-point
			JumpPointAPI jumpPoint2 = Global.getFactory().createJumpPoint("kumarikandam_jump", "Ponte de Rama");
		...
		system.addAsteroidBelt(kumarikandam_star, 150, 5900, 128, 200, 240, Terrain.ASTEROID_BELT, "O Mullam");
