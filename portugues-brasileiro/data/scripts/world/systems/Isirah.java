...
public class Isirah {
	...
	public void generate(SectorAPI sector) {
		...
		JumpPointAPI jumpPoint2 = Global.getFactory().createJumpPoint("isirah_jump", "Ponto de Salto Interno de Isirah");
		...
		SectorEntityToken ring1 = system.addTerrain(Terrain.RING, new RingParams(900, 3500, null, "Muralha de Utgarda"));
		...
		SectorEntityToken isirah_d1 = system.addTerrain(Terrain.ASTEROID_FIELD,
				new AsteroidFieldParams(
					...
					"Enxame de Acreção de Corb")); // null for default name
		...
		SectorEntityToken station1 = system.addCustomEntity("laicaille_habitat", "Habitat de Laicaille", "station_side00", "persean");
		...
		SectorEntityToken station2 = system.addCustomEntity("station_kapteyn", "Estaleiros Estelares de Kapteyn", "station_mining00", "pirates");
		...
		SectorEntityToken gate = system.addCustomEntity("isirah_gate", // unique id
				 "Portal de Isirah", // name - if null, defaultName from custom_entities.json will be used
		...
		SectorEntityToken ring2 = system.addTerrain(Terrain.RING, new RingParams(900, 4900, null, "Disco de Vosud"));
		...
		SectorEntityToken station3 = system.addCustomEntity("groombridge_habitat", "Habitat Groombridge", "station_side00", "neutral");
