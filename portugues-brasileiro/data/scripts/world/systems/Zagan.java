...
public class Zagan {
	...
	public void generate(SectorAPI sector) {
		...
		system.addAsteroidBelt(zagan_star, 90, 3650, 500, 150, 300, Terrain.ASTEROID_BELT,  "Bancos de Areia da Perdição");
		...
		mazalot_magfield.setCircularOrbit(mazalot, 0, 0, 100);
			...
			SectorEntityToken relay = system.addCustomEntity("mazalot_relay", // unique id
					 "Rele Mazalot", // name - if null, defaultName from custom_entities.json will be used
			...
			SectorEntityToken gate = system.addCustomEntity("mazalot_gate", // unique id
					 "Portal Mazalot", // name - if null, defaultName from custom_entities.json will be used
		...
		// Zagan jump-point
		JumpPointAPI jumpPoint2 = Global.getFactory().createJumpPoint("yesod_jump", "Ponto de Salto Yesod");
