...
public class Eos {
	...
	public void generate(SectorAPI sector) {
		StarSystemAPI system = sector.createStarSystem("Êxodo de Eos");
		...
		eos1.getSpec().setAtmosphereColor(new Color(255,150,50,205));
			...
			SectorEntityToken phaosphorosL4 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						"Asteroides Querubins")); // null for default name
			...
			SectorEntityToken phaosphorosL5 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						4f, // min asteroid radius 
						12f, // max asteroid radius
						"Asteroides Seráficos")); // null for default name
		...
		eos2.setInteractionImage("illustrations", "tartessus");
			...
			system.addRingBand(eos2, "misc", "rings_special0", 256f, 1, new Color(225,215,255,200), 128f, 380, 30f, Terrain.RING, "A Graça de Tartessus"); 
			// 256f
		
			// Tartessus Jumppoint - Tartessus L5 (behind)
			JumpPointAPI eos2JumpPoint = Global.getFactory().createJumpPoint("paladins_bridge", "Ponte dos Paladinos");
		...
		system.addAsteroidBelt(star, 150, 6000, 250, 150, 250, Terrain.ASTEROID_BELT, "Os Peregrinos");
		...
		SectorEntityToken relay = system.addCustomEntity("hesperus_relay", "Rele de Hesperus", "comm_relay", "luddic_church");
		...
		SectorEntityToken gate = system.addCustomEntity("eos_exodus_gate", // unique id
				 "Portal Êxodo de Éos", // name - if null, defaultName from custom_entities.json will be used
