...
public class Askonia {
	...
	public void generate(SectorAPI sector) {
		...
		a1.setInteractionImage("illustrations", "sindria");
			...
			JumpPointAPI jumpPoint = Global.getFactory().createJumpPoint("askonia_jump_point_alpha", "Ponto de salto de Sindria");
			...
			SectorEntityToken sindria_relay = system.addCustomEntity("sindria_relay", // unique id
					 "Retransmissor de Sindria", // name - if null, defaultName from custom_entities.json will be used
		...
		system.addAsteroidBelt(star, 150, 3600, 170, 200, 250, Terrain.ASTEROID_BELT, "Rio de Pedra");
	...
	// Salus system
		...
		a2.applySpecChanges();
			...
			system.addAsteroidBelt(a2, 50, 1100, 128, 40, 80, Terrain.ASTEROID_BELT, "Anel de Opis");
			...
			SectorEntityToken opis_debris_cloud = system.addTerrain(Terrain.ASTEROID_FIELD,
				new AsteroidFieldParams(
					...
					"Nuvem de Detritos de Opis")); // null for default name
			...
			a2b.setInteractionImage("illustrations", "volturn");
				...
				SectorEntityToken salus_nav = system.addCustomEntity(null, "Boia de Navegação de Salus", "nav_buoy", Factions.DIKTAT); 
			...
			system.addRingBand(a2, "misc", "rings_dust0", 256f, 1, Color.white, 256f, 1800, 110f, Terrain.RING, "Anel de Poeira");
			...
			system.addRingBand(a2, "misc", "rings_ice0", 256f, 1, Color.white, 256f, 2150, 90f, Terrain.RING, "Anel de Nuvens");
		...
		// Nortia - Independent (Charterist) base - caught in Salus' L4
			...
			SectorEntityToken salusL4 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						"Asteroides de Salus L4")); // null for default name
			...
			SectorEntityToken salusL5 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						4f, // min asteroid radius 
						16f, // max asteroid radius
						"Asteroides de Salus L5")); // null for default name
			
			salusL4.setCircularOrbit(star, 230 + 60, 7500, 250);
			salusL5.setCircularOrbit(star, 230 - 60, 7500, 250);
			
			// Askonia Outer Jump (in Salus L5)
			JumpPointAPI jumpPoint2 = Global.getFactory().createJumpPoint("salus_jump", "Ponto de Salto de Salus L5");
			...
			SectorEntityToken askonia_gate = system.addCustomEntity("askonia_gate", // unique id
					 "Portal de Askonia", // name - if null, defaultName from custom_entities.json will be used
		...
		SectorEntityToken askonia_outer_array = system.addCustomEntity(null, "Estacao de Escuta da Franja de Askonia", "sensor_array_makeshift", Factions.DIKTAT); 
...
//				 360f); // max spin (degrees/day)
		...
		SectorEntityToken station = system.addCustomEntity("diktat_cnc", "Comando & Controle", "station_side02", "sindrian_diktat");
