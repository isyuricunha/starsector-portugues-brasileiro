...
public class Thule {
	...
	public void generate(SectorAPI sector) {	
		...
		system.addAsteroidBelt(thule_star, 90, 3750, 500, 100, 120, Terrain.ASTEROID_BELT,  "O Ingwin");
		...
		system.addAsteroidBelt(thule_star, 90, 4550, 500, 290, 310, Terrain.ASTEROID_BELT,  "A Banda de Hama");
		...
		//kazeronStation.setInteractionImage("illustrations", "orbital");
			...
			// Kazeron jump-point
			JumpPointAPI jumpPoint1 = Global.getFactory().createJumpPoint("thule_jump", "Ponto de Salto de Thule");
			...
			SectorEntityToken kazeron_relay = system.addCustomEntity("kazeron_relay", "Rele de Kazeron",  "comm_relay", Factions.PERSEAN); 
			kazeron_relay.setCircularOrbitPointingDown( thule_star, 150, 5200, 225);
			
		system.addAsteroidBelt(thule_star, 90, 5950, 500, 150, 300, Terrain.ASTEROID_BELT,  "A Coroa de Inged");
		...
		eldfell.setCustomDescriptionId("planet_eldfell");
				...
				SectorEntityToken gate = system.addCustomEntity("thule_gate", // unique id
						 "Portal de Thule", // name - if null, defaultName from custom_entities.json will be used
		...
		system.addAsteroidBelt(thule_star, 90, 7650, 500, 150, 300, Terrain.ASTEROID_BELT,  "O Anel de Garmund");
		...
		system.addRingBand(thule_star, "misc", "rings_ice0", 256f, 1, new Color(230,240,255,255), 256f, 7870, 395, null, null);
			...
			SectorEntityToken thule_pirate_station = system.addCustomEntity("thule_pirate_station",
					"Base de Saqueadores Thulianos", "station_pirate_type", "pirates");
		...
		morn.applySpecChanges();
			...
			SectorEntityToken nebula1 = system.addTerrain(Terrain.NEBULA, new BaseTiledTerrain.TileParams(
					...
					"terrain", "nebula", 4, 4, "Nuvem Morn L5"));
			...
			SectorEntityToken nebula2 = system.addTerrain(Terrain.NEBULA, new BaseTiledTerrain.TileParams(
					...
					" x    ",
					6, 6, // size of the nebula grid, should match above string
					"terrain", "nebula", 4, 4, "Nuvem Morn L4"));
