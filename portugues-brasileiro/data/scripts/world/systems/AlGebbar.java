...
public class AlGebbar {
	...
	public void generate(SectorAPI sector) {
		...
		// Al Gebbar Jumppoint
		JumpPointAPI jumpPoint2 = Global.getFactory().createJumpPoint("algebbar_jump", "Ponto de salto de Al Gebbar");
		...
		PlanetAPI gebbar5 = system.addPlanet("gebbar5", algebbar_star, "Loutron", "cryovolcanic", 90, 120, 6400, 295);
			...
			SectorEntityToken abandoned_station = system.addCustomEntity("abandoned_station", "Âncora de Skyhook Abandonado", "station_mining00", "neutral");
