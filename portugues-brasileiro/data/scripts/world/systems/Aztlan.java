...
public class Aztlan {
	...
	public void generate(SectorAPI sector) {
		...
		system.addAsteroidBelt(aztlan_star, 150, 3100, 128, 60, 80, Terrain.ASTEROID_BELT, "O Ciltetl");
	...
	// Chicomoztoc & friends
		...
		aztlan2.setInteractionImage("illustrations", "urban03");
			...
			SectorEntityToken hegemonyStation = system.addCustomEntity("aztlan_starport", "Espacoporto de Aztlan", "station_lowtech2", "hegemony");
			...
			JumpPointAPI jumpPoint_aztlan = Global.getFactory().createJumpPoint("aztlan_jump_point_alpha", "Ponto de Salto Interno de Aztlan");
			...
			SectorEntityToken gate = system.addCustomEntity("aztlan_gate", // unique id
					 "Portal de Aztlan", // name - if null, defaultName from custom_entities.json will be used
	...
	// Tlalocan System
		...
		aztlan3.applySpecChanges();
			...
			SectorEntityToken coatl_station = system.addCustomEntity("coatl_station", "Bastião Coatl", "station_side02", "hegemony");
			...
			SectorEntityToken relay = system.addCustomEntity("aztlan_relay", // unique id
					 "Rele de Aztlan", // name - if null, defaultName from custom_entities.json will be used
		...
		JumpPointAPI jumpPoint_aztlan2 = Global.getFactory().createJumpPoint("aztlan_jump_point_beta", "Ponto de Salto Externo de Aztlan");
