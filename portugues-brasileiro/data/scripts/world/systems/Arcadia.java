	...
	public void generate(SectorAPI sector) {
		...
		system.addAsteroidBelt(arcadia2, 20, 1000, 128, 40, 80, Terrain.ASTEROID_BELT, null);
			...
			SectorEntityToken relay = system.addCustomEntity("syrinx_relay", // unique id
					 "Retransmissor de Syrinx", // name - if null, defaultName from custom_entities.json will be used
					 "comm_relay_makeshift", // type of object, defined in custom_entities.json
					 "hegemony"); // faction
			relay.setCircularOrbitPointingDown( system.getEntityById("arcadia"), 180 + 60, 6000, 200);
			
			// lagrangian point of Syrinx
			JumpPointAPI jumpPoint = Global.getFactory().createJumpPoint("syrinx_passage","Passagem de Syrinx");
...
//		arc_station.setCustomDescriptionId("station_arcadia"); 
		...
		SectorEntityToken arc_station = system.addCustomEntity("arcadia_station", "Cidadela de Arcadia", "station_side02", "hegemony");
