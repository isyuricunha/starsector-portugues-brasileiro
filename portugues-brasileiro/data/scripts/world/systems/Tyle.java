...
public class Tyle {
	...
	public void generate(SectorAPI sector) {
		...
		system.addAsteroidBelt(tyle_star, 60, 4350, 170, 200, 250, Terrain.ASTEROID_BELT, "Arquipélago de Tyle");
...
/*			SectorEntityToken gate = system.addCustomEntity("wuya_gate", // unique id
		...
		// Wuya Jump
		JumpPointAPI jumpPoint1 = Global.getFactory().createJumpPoint("wuya_jump", "Salto da Wuya");
		...
		tyle_d.setCustomDescriptionId("planet_canaria");
			...
			// Canaria Relay
			SectorEntityToken canaria_relay = system.addCustomEntity("canaria_relay", "Rede Canaria", "comm_relay", "persean");
