...
public class Penelope {
	...
	public void generate(SectorAPI sector) {
		...
		StarSystemAPI system = sector.createStarSystem("Estrela de Penélope");
...
//		system.addRingBand(penelope_star, "misc", "rings_asteroids0", 256f, 3, Color.white, 256f, 13750, 345f, Terrain.ASTEROID_BELT, null);
		...
		penelope3.setCustomDescriptionId("planet_ogygia");
			...
			JumpPointAPI p_jumpPoint = Global.getFactory().createJumpPoint("penelope_jump", "Ponto de Salto Interno de Penélope");
		...
		penelope4_field.setCircularOrbit(penelope4, 0, 0, 100);
			...
			SectorEntityToken penelopeL4 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						"Asteroides L4 de Penélope")); // null for default name
			...
			SectorEntityToken penelopeL5 = system.addTerrain(Terrain.ASTEROID_FIELD,
					new AsteroidFieldParams(
						...
						4f, // min asteroid radius 
						16f, // max asteroid radius
						"Asteroides Penelope L5")); // null for default name
		...
		// Telepylus station : staging area for volatiles transport Oxen
			SectorEntityToken telepylus_station = system.addCustomEntity("telepylus_station", "Estação Telepylus", "station_sporeship_derelict", "neutral");
		...
		// Outer system jump-point
			...
			JumpPointAPI p_jumpPoint2 = Global.getFactory().createJumpPoint("penelope_jump", "Ponto de Salto Exterior de Penelope");
...
//		system.addAsteroidBelt(penelope_star, 100, 13750, 200, 330, 360, Terrain.ASTEROID_BELT, "The Cyclopeans");
		system.addAsteroidBelt(penelope_star, 100, 13750, 200, 330, 360, Terrain.ASTEROID_BELT, "Os Ciclopes");
