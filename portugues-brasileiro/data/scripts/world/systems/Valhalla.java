...
public class Valhalla {
	...
	public void generate(SectorAPI sector) {
		...
		system.addAsteroidBelt(star, 100, 3150, 256, 150, 250, Terrain.ASTEROID_BELT, "As Valquírias");
		
			// Valkyrie jump
			JumpPointAPI jumpPoint = Global.getFactory().createJumpPoint("valkyrie_jump", "Ponto de salto das Valquírias");
		...
		system.addAsteroidBelt(star, 100, 3350, 256, 150, 250, Terrain.ASTEROID_BELT, "As Valquírias");
			...
			//val2c.setInteractionImage("illustrations", "vacuum_colony");
				...
				SectorEntityToken yggdrasilL4 = system.addTerrain(Terrain.ASTEROID_FIELD,
						new AsteroidFieldParams(
							...
							"Asteroides L4 de Yggdrasil")); // null for default name
				...
				SectorEntityToken yggdrasilL5 = system.addTerrain(Terrain.ASTEROID_FIELD,
						new AsteroidFieldParams(
							...
							4f, // min asteroid radius 
							16f, // max asteroid radius
							"Asteroides L5 de Yggdrasil")); // null for default name
...
//		mimir_station.setCustomDescriptionId("station_mimir");
		...
		SectorEntityToken mimir_station = system.addCustomEntity("mimir_platform", "Plataforma de Sifão Mimir", "station_side05", "tritachyon");
...
//		initStationCargo(mimir_station);
	...
	// orbited by station, relay, and asteroid field each 1/3rd orbit off from one another.
		...
		// Ragnar Complex
			SectorEntityToken ragnar_station = system.addCustomEntity("ragnar_complex", "Complexo Ragnar", "station_side02", "hegemony");
		...
		// Ragnar Relay
			SectorEntityToken relay = system.addCustomEntity("ragnar_relay", // unique id
					 "Relé de Ragnar", // name - if null, defaultName from custom_entities.json will be used
		...
		// The Vipers (asteroid field)
			...
			new AsteroidFieldParams(
				...
				4f, // min asteroid radius 
				16f, // max asteroid radius
				"As Vipers")); // null for default name
		...
		JumpPointAPI jumpPoint_ragnar = Global.getFactory().createJumpPoint("ragnar_jump", "Ponto de salto de Ragnar");
