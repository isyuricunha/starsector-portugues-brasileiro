...
public class Naraka {
	...
	public void generate(SectorAPI sector) {
		...
		system.addRingBand(naraka_star, "misc", "rings_dust0", 256f, 0, Color.white, 256f, 3300, 220f, Terrain.RING, "O Yamuna");
		...
		// Yamidutas : asteroids
		system.addAsteroidBelt(naraka_b, 60, 900, 170, 200, 250, Terrain.ASTEROID_BELT, "Os Servos");
		...
		JumpPointAPI jumpPoint1 = Global.getFactory().createJumpPoint("naraka_jump", "Ponto de Salto de Naraka");
		jumpPoint1.setCircularOrbit( system.getEntityById("naraka"), 60 + 60, 4600, 140);
		jumpPoint1.setRelatedPlanet(naraka_c);
		system.addEntity(jumpPoint1);
		
		// Naraka Relay
		SectorEntityToken relay = system.addCustomEntity("naraka_relay", "Relé de Naraka", "comm_relay", "hegemony");
