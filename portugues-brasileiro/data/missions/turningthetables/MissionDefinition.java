...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "ISS Hamatsu e ISS Black Star com escolta de drones");
		api.setFleetTagline(FleetSide.ENEMY, "Forças do Caminho Luddico");
		
		// These show up as items in the bulleted list under 
		// "Tactical Objectives" on the mission detail screen
		api.addBriefingItem("Derrote todas as forças inimigas");
		api.addBriefingItem("A ISS Black Star e a ISS Hamatsu devem sobreviver");
		api.addBriefingItem("Mantenha-se próximo à ISS Hamatsu (cruzador aliado) para segurança");
