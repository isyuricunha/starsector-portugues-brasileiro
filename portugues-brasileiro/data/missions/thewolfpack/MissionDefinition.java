...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "Saques mercenários");
		api.setFleetTagline(FleetSide.ENEMY, "Comboio da Hegemonia com escolta");
		
		// These show up as items in the bulleted list under 
		// "Tactical Objectives" on the mission detail screen
		api.addBriefingItem("O comboio da Hegemonia tentará fugir em direção ao topo do mapa");
		api.addBriefingItem("Controlar as boias de navegação é fundamental para evitar uma fuga rápida");
		api.addBriefingItem("Ordenar uma busca e destruição em toda a frota tornará suas naves mais agressivas");
		api.addBriefingItem("Ordenar que suas naves eliminem um alvo as tornará mais agressivas");
