...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "ISS Athena na liderança de uma frota de reconhecimento");
		api.setFleetTagline(FleetSide.ENEMY, "HSS Phoenix e destacamentos de guarda de instalações da Hegemonia");
...
//		api.addBriefingItem("Ships ordered to retreat will escape along the top edge of the map");
		api.addBriefingItem("Derrote as forças inimigas");
		api.addBriefingItem("A ISS Enki deve sobreviver — ela carrega equipamentos científicos insubstituíveis");
		api.addBriefingItem("Destrua primeiro os navios de escolta inimigos, depois ataque o coração de sua frota.");
