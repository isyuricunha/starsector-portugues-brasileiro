...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "Marinha Mayasuriana com complemento pesado de caças");
		api.setFleetTagline(FleetSide.ENEMY, "Frota da Hegemonia sob o comando do Comodoro Jensulte");
		
		// These show up as items in the bulleted list under 
		// "Tactical Objectives" on the mission detail screen
		api.addBriefingItem("Derrote todas as forças inimigas");
		api.addBriefingItem("A MSS Garuda deve sobreviver");
		api.addBriefingItem("Mantenha a consciência tática e use sua mobilidade superior para escolher suas batalhas.");
		api.addBriefingItem("Lembre-se: se você enfrentar a nave capitânea inimiga em uma luta justa, você perderá.");
