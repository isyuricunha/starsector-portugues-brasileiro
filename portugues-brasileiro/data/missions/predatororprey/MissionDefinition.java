...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "patrulha da Hegemonia");
		api.setFleetTagline(FleetSide.ENEMY, "destacamento de porta-aviões da Tri-Tachyon");
		
		// These show up as items in the bulleted list under 
		// "Tactical Objectives" on the mission detail screen
		api.addBriefingItem("Derrote as forças inimigas");
		api.addBriefingItem("Caças inimigos em retirada o levarão até seu porta-aviões");
		api.addBriefingItem("Sincronize seu avanço com o ritmo dos ataques de torpedos inimigos");
		...
		api.addToFleet(FleetSide.ENEMY, "astral_Strike", FleetMemberType.SHIP, "Efêmero TTS", false);
