...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "Força de ataque conjunta do ISS Black Star e do Caminho Luddico");
		api.setFleetTagline(FleetSide.ENEMY, "PLS Praxis com escolta e aliados da Tri-Tachyon");
		
		// These show up as items in the bulleted list under 
		// "Tactical Objectives" on the mission detail screen
		api.addBriefingItem("Distraia a nave capitânea inimiga para permitir que seus bombardeiros a flanqueiem");
		api.addBriefingItem("Derrote todas as forças inimigas");
		api.addBriefingItem("O ISS Black Star deve sobreviver");
