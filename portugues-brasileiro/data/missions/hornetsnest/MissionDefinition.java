...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "ISS Van Rijn e frota de salvamento");
		api.setFleetTagline(FleetSide.ENEMY, "Forças da coalizão pirata Kanta");
		
		// These show up as items in the bulleted list under 
		// "Tactical Objectives" on the mission detail screen
		api.addBriefingItem("Derrote todas as forças inimigas");
		//api.addBriefingItem("ISS Van Rijn must survive");
		api.addBriefingItem("Você tem Pontos de Comando muito limitados");
		api.addBriefingItem("Concentre suas forças superiores para derrotar o inimigo em detalhes");
