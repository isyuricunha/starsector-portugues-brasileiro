...
public class HardenedSubsystems extends BaseHullMod {
	...
	public void addPostDescriptionSection(TooltipMakerAPI tooltip, HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
		...
		tooltip.addSectionHeading("Decaimento da prontidão de combate", Alignment.MID, opad);
		
		tooltip.addPara("Sem este modificador de casco ou quaisquer outros modificadores, levaria %s segundos para "
				+ "esta nave perder %s de prontidão de combate, após o término do seu tempo de desempenho máximo.", opad,
		...
		tooltip.addPara("Com todas as modificações atualmente instaladas na nave, levará %s segundos.",
	...
	public String getUnapplicableReason(ShipAPI ship) {
		return "A nave não sofre degradação de PC";
	}
}
